...
import com.example.inf1030_tp1.Activities.MainActivityPharma;
...
public class TypeUserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView.findViewById(R.id.btn_pharma).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SharedPreferences preferences = getActivity().getSharedPreferences(Utils.SHARED_PREF_USER_INFO, Context.MODE_PRIVATE);
                preferences.edit()
                ...
                Intent intent = new Intent(getActivity(), MainActivityPharma.class);
                startActivity(intent);
            }
        });
        return mView;
