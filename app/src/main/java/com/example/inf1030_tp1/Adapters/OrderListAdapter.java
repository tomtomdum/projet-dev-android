...
import com.example.inf1030_tp1.fragments.pharmacist.OrderFragmentPharma;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.i("View Name : ","OK : " + context.getClass().getSimpleName().toString());
                Utils.sOrder = order;
                if(context.getClass().getSimpleName().toString().equals("MainActivityPharma")){
                    AppCompatActivity activity = (AppCompatActivity) view.getContext();

                    Fragment myFragment = new OrderFragmentPharma();
                    activity.getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container_pharma, myFragment).addToBackStack(null).commit();
                }
